#ifndef SWEETGLMODEL_H
#define SWEETGLMODEL_H
#pragma once
...
public:
	...
	//SweetGLModel(string const &path, bool gamma = false) : gammaCorrection(gamma)
	//{
	//	loadModel(path);
	//}
...
private:
	...
	Mesh processMesh(aiMesh *mesh, const aiScene *scene)
	{
		...
		{
			Vertex vertex;
			vmath::vec3 vector; // we declare a placeholder vector since assimp uses its own vector class that doesn't directly convert to glm's vec3 class so we transfer the data to this placeholder glm::vec3 first.
								// positions
